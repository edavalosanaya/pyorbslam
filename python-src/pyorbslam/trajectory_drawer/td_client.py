...
class TDClient:
    ...
    def create_visual(self, name: str, vtype: Literal['line', 'mesh', 'point cloud'], data: Any):
    ...
    def update_visual(self, name: str, vtype: Literal['line', 'mesh', 'point cloud'], data: Any):
