...
public:
    ...
    void PreSave(set<shared_ptr<KeyFrame>>& spKF,set<shared_ptr<MapPoint>>& spMP);
    void PostLoad(map<long unsigned int, shared_ptr<KeyFrame>>& mpKFid, map<long unsigned int, shared_ptr<MapPoint>>& mpMPid);
