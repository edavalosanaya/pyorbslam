...
protected:
    ...
    std::vector<shared_ptr<KeyFrame>> mvpEnoughConsistentCandidates;
    std::vector<shared_ptr<KeyFrame>> mvpCurrentConnectedKFs;
    std::vector<shared_ptr<MapPoint>> mvpCurrentMatchedPoints;
    ...
    std::vector<shared_ptr<KeyFrame>> mvpMergeConnectedKFs;
